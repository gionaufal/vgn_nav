...
Gem::Specification.new do |spec|
  spec.name          = "vgn_nav"
  spec.license       = "MIT"
  spec.version       = VgnNav::VERSION
  spec.authors       = ["Giovanni Filippetti"]
  spec.email         = ["giovanni.filippetti@suse.com"]

  spec.summary       = %q{Simple CLI tool to fetch next transports for stations in Nuremberg and surroundings.}
  spec.description   = %q{Simple CLI tool to fetch next transports for stations in Nuremberg and surroundings.}
  spec.homepage      = 'https://gionaufal.com'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = 'https://github.com/gionaufal/vgn_nav'
    spec.metadata["changelog_uri"] = "https://gionaufal.com"
  else
